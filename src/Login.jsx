        ...
        <div className="flex h-full items-center justify-center ">
          <div className="md:w-8/12 lg:ms-6 lg:w-5/12 border-[0.5px] border-test  px-5 py-2 rounded-md bg-slate-50">
            ...
            <form>
              ...
              <button
                type="button"
                className="inline-block w-[100%] rounded bg-primary px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-blue-500 shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 dark:shadow-black/30 mb-10"
              ...
              <div className="text-center text-md font-semibold text-primary ">
                <p>
                  Bạn chưa có tài khoản? &ensp; <span className="cursor-pointer hover:text-red-500 transition-all duration-300"> <a to={"/register"}>Đăng ký</a></span>
                </p>
              </div>
            </form>
          </div>
